...
\definecolor{responseblue}{HTML}{174A7E}
\title{Response to Reviewers\\[4pt]
\large Independent control of sequence-correlation amplitude tunes post-quench composition\\
fluctuations in A/B heteropolymer melts}
...
\pagestyle{plain}
\section*{Reviewer 2}
\subsection*{Comment 11: RPA calculation (follow-up)}
\begin{quote}
\textit{Summary of the comment. The RPA treatment is unclear. A matrix treatment along the lines of \emph{Scaling Law for Sequence-Induced Demixing of Compositionally Identical Copolymers} was expected, rather than an unexplained scalar equation or an apparent dilute limit in which chain repulsions do not matter. The paragraph preceding Eq.~(11) is also unclear. Since the RPA was optional, it may be corrected or removed.}
\end{quote}
\textcolor{responseblue}{\textbf{Response.}} Thank you for identifying the ambiguity in the RPA presentation and for pointing me to Rumyantsev and Gavrilov, \emph{Scaling Law for Sequence-Induced Demixing of Compositionally Identical Copolymers}. I have corrected this part of the manuscript and clarified the purpose and limits of the calculation.
...
\textcolor{responseblue}{\textbf{Location in revision:} Abstract; paragraph preceding Eq.~(11) and the matrix-RPA formulation in Results; Fig.~4d and its caption; corresponding Discussion and Methods passages; Supplementary Information section \emph{Two-component melt response and the symmetric projection}.}
\end{document}
