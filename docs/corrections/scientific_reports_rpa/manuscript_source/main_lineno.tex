...
% Review layout: figures are supplied as separate files and the complete
% legends are collected after the references, following the Scientific Reports
% submission instructions.
\newcommand{\figurecallout}[1]{%
  \refstepcounter{figure}\label{#1}%
  \begin{center}\textit{[Figure \thefigure\ near here]}\end{center}}
...
\figurecallout{fig:sequence_construction}
...
\figurecallout{fig:kappa_controls}
...
\figurecallout{fig:persistence_response}
...
\figurecallout{fig:sequence_response}
...
\figurecallout{fig:cross_attraction}
